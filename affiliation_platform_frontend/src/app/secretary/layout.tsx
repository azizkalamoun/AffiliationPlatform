            ...
            <nav className="flex flex-col px-2  font-medium  lg:px-4 relative h-fit space-y-2">
              ...
              <div className="flex flex-col">
                ...
                >
                  ...
                  <Link
                    href="/secretary/promotion-requests/"
                    className="flex items-center gap-3 rounded-md px-3 py-2  text-primary transition-all duration-300 ease-in-out hover:bg-background hover:text-primary text-sm"
                  >
                    Promotion Requests
                    <Badge
              ...
              <div className="flex flex-col">
                ...
                >
                  ...
                  <Link
                    href="/secretary/registration-requests/"
                    className="flex items-center gap-3 rounded-md px-3 py-2 text-sm   text-primary transition-all duration-300 ease-in-out hover:bg-background hover:text-primary"
                  >
                    Registration Requests
                    <Badge
                      className={`ml-auto z-50 h-5 w-2 shrink-2 items-center text-sm  justify-center  ${
